...
@JsonDeserialize(
    using = RetrieveException.Deserializer.class
)
public final class RetrieveException extends Exception {
  ...
  private RetrieveException(Value value, int statusCode) {
    this.value = value;
  ...
  public static RetrieveException other(Object unknownValue, int statusCode) {
    return new RetrieveException(new UnknownErrorValue(unknownValue), statusCode);
  }
  ...
  private static final class UnknownErrorValue implements Value {
    ...
    public String toString() {
      return "RetrieveException{" + "unknownValue: " + unknownValue + "}";
    }
  }

  static final class Deserializer extends JsonDeserializer<RetrieveException> {
    @Override
    public RetrieveException deserialize(JsonParser p, DeserializationContext ctx) throws
        IOException {
      Value value = ctx.readValue(p, Value.class);
      int statusCode = (int) ctx.getAttribute("statusCode");
      return new RetrieveException(value, statusCode);
    }
  }
}
